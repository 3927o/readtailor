/** Verifies active wire contracts and retained database-compatibility payloads. */
...
describe('phase three workflow contracts', () => {
  ...
  it('binds the formal generation queue payload to direct business ids', () => {
    expect(
...
describe('legacy database compatibility contracts', () => {
  it('keeps operation payload validation for rows stored by the retired workflow', () => {
