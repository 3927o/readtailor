...
function createUserBookServiceForUser(
  ...
  const {
    ...
    resolve: resolveReadingSetupOperation,
    prepareExecution: prepareReadingSetupOperationExecution,
    startLeaseRenewal: startOperationLeaseRenewal,
    fail: failReadingSetupOperation,
