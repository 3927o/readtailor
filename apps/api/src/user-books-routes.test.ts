/** Verifies active user-book HTTP routes and the removal of legacy Setup endpoints. */
...
describe('user book workflow routes', () => {
  ...
  it.each([
    ...
    ['POST', '/interview/resume/stream'],
    ['GET', '/strategy'],
    ['GET', '/strategy/versions/55555555-6666-4777-8888-999999999999'],
    ['POST', '/strategy/feedback'],
    ['POST', '/strategy/feedback/stream'],
    ['POST', '/strategy/approve'],
    ['POST', '/strategy/approve/stream'],
    ['GET', '/trial'],
    ['GET', '/trial/revisions/66666666-7777-4888-8999-aaaaaaaaaaaa'],
    ['POST', '/trial/feedback'],
    ['POST', '/trial/feedback/stream'],
    ['POST', '/trial/adopt'],
    ['POST', '/trial/retry'],
    ['POST', '/trial/viewed'],
    ['GET', '/reading-setup-operation/current'],
    ['GET', '/reading-setup-operation/44444444-5555-4666-8777-888888888888'],
    ['POST', '/reading-setup-operation/44444444-5555-4666-8777-888888888888/resume'],
  ] as const)('returns 404 for retired setup route %s %s', async (method, path) => {
    const app = await buildApp();
    const response = await app.inject({
      method,
